...
Funcionalidade: Aprender Cucumber
	...
	Para que eu possa automatizar critÃ©rios de aceitaÃ§Ã£o
...
Cenário: Deve incrementar contador
	...
	Então o valor do contador é 158
...
Cenário: Deve reaproveitar os steps "Dado" do cenpario anterior
	Dado que o ticket é AB167
	Dado que o ticket especial é AB167
	Dado que o valor da passagem é R$ 1120,23
	Dado que o nome do passageiro é "Ciclano de Oliveira"
...
Cenário: Deve negar todos os steps "Dado" dos cenários anteriores
	...
	Dado que o nome do passageiro é "Beltrano Souza Matos de AlcÃ¢ntara Azevedo"
